...
import lv.javaguru.java2.cakeConstructor.privious.cake.domain.NewCake;

import java.util.List;
import java.util.ArrayList;

import static lv.javaguru.java2.cakeConstructor.privious.new_ingridient_type.IngridientBuilder.createIngridient;
