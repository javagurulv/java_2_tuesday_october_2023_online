insert into products(product_name, product_brand, product_model, product_quantity, price)
values ('Smartphone', 'Apple', 'iPhone 15', 1, 1000);

insert into products(product_name, product_brand, product_model, product_quantity, price)
values ('Smartphone', 'Apple', 'iPhone 14', 1, 800);
