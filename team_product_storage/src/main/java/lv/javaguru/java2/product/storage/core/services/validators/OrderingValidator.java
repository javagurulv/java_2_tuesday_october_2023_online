...
public class OrderingValidator {
    ...
    private Optional<CoreError> validateOrderBy(Ordering ordering) {
        return (ordering.getOrderBy() != null
                && !(ordering.getOrderBy().equals("productModel") || ordering.getOrderBy().equals("productBrand")))
                ? Optional.of(new CoreError("orderBy", "Must contain 'productModel' or 'productBrand' only!"))
                : Optional.empty();
    }
