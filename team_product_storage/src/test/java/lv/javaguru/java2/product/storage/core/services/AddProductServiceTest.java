...
public class AddProductServiceTest {
    ...
    public void shouldReturnResponseWithErrorsWhenValidationFailsWhenProductNameIsEmpty() {
        AddProductRequest notValidRequest = new AddProductRequest(null, "Apple", "iPhone 15", 1);
    ...
    public void shouldReturnResponseWithErrorsWhenValidationFailsWhenProductQuantityIsNull() {
        AddProductRequest notValidRequest = new AddProductRequest("Smartphone", "Apple", "iPhone 15", 0);
    ...
    public void shouldReturnResponseWithErrorsWhenValidationFailsWhenProductBrandIsEmpty() {
        AddProductRequest notValidRequest = new AddProductRequest("Smartphone", null, "iPhone 15", 1);
    ...
    public void shouldReturnResponseWithErrorsWhenValidationFailsWhenProductModelIsEmpty() {
        AddProductRequest notValidRequest = new AddProductRequest("Smartphone", "Apple", null, 1);
    ...
    public void shouldAddProductToDatabaseWhenRequestIsValid() {
        AddProductRequest validRequest = new AddProductRequest("Smartphone", "Apple", "iPhone 15",1);
