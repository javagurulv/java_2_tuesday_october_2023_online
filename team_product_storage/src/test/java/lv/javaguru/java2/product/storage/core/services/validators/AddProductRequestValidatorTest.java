...
public class AddProductRequestValidatorTest {
    ...
    public void shouldReturnErrorWhenProductQuantityIsNull() {
        AddProductRequest request = new AddProductRequest("Smartphone", "Apple", "iPhone 15", null, new BigDecimal("1000.00"));
        List<CoreError> errors = validator.validate(request);
        assertEquals(errors.size(), 1);
...
//        AddProductRequest request = new AddProductRequest(null, null, null, null, new BigDecimal(("0.00")));
//        List<CoreError> errors = validator.validate(request);
...
//    }
    ...
    public void shouldReturnErrorWhenDuplicateFound() {
        productRepository = Mockito.mock(JpaProductRepository.class);
