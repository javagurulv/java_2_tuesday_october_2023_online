...
class DayCountCalculatorTest {
    ...
    void setUp() {
        ...
        agreement.setAgreementDateFrom(Date.from(LocalDate.of(2023, 1, 5).atStartOfDay(ZoneId.systemDefault()).toInstant()));
        agreement.setAgreementDateTo(Date.from(LocalDate.of(2023, 1, 15).atStartOfDay(ZoneId.systemDefault()).toInstant()));
    }
