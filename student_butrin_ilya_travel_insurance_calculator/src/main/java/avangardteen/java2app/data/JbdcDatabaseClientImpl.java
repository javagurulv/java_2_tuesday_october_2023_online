...
public class JbdcDatabaseClientImpl implements DatabaseClient {
  ...
  //  public void addClient(Client client) {
    //    jdbcTemplate.update( "INSERT INTO client (first_name, last_name, phone, e_mail, wheelchair, antropometricSizes)" +
   //     "values (?,?,?,?,?,?)",  client.getFirstName(), client.getLastName(), client.getPhoneNumber(), client.getE_mail(), client.getWheelchair().getId(), client.getUserSizes().getId());
  //  }
    public void addClient(Client client) {
