...
class DayCountCalculatorTest {
    ...
    void setUp() {
        ...
        request.setAgreementDateFrom(Date.from(LocalDate.of(2023, 7, 1).atStartOfDay(ZoneId.systemDefault()).toInstant()));
        request.setAgreementDateTo(Date.from(LocalDate.of(2023, 7, 11).atStartOfDay(ZoneId.systemDefault()).toInstant()));
    }
