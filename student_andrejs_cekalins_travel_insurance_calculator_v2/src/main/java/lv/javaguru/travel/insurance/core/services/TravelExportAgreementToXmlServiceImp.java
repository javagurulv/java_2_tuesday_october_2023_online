...
@Component
@Transactional
class TravelExportAgreementToXmlServiceImp implements  TravelExportAgreementToXmlService {

    private static final Logger logger = LoggerFactory.getLogger(TravelExportAgreementToXmlServiceImp.class);
    ...
    public TravelExportAgreementToXmlServiceImp(TravelGetAgreementService agreementService,
