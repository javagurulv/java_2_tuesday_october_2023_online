...
public class PersonLevelV2TestCases extends TravelCalculatePremiumControllerV2TestCase {
    ...
    @Test
    @DisplayName("ERROR_CODE_1 one personFirstName is NULL, must not be empty")
    public void check_ERROR_CODE_1_NULL() throws Exception {
        executeAndCompare(TEST_FILE_BASE_FOLDER + "/ERROR_CODE_1_personFirstName_is_null");
    }

    @Test
    @DisplayName("ERROR_CODE_1 one personFirstName is empty, must not be empty")
    public void check_ERROR_CODE_1_EMPTY() throws Exception {
        executeAndCompare(TEST_FILE_BASE_FOLDER + "/ERROR_CODE_1_personFirstName_is_empty");
    }

    @Test
    @DisplayName("ERROR_CODE_1 two personFirstName is empty, must not be empty")
    public void check_ERROR_CODE_1_two_persons_empty() throws Exception {
        executeAndCompare(TEST_FILE_BASE_FOLDER + "/ERROR_CODE_1_two_personFirstName_is_empty");
    }


    @Test
    @DisplayName("ERROR_CODE_1 two personFirstName is NULL, must not be empty")
    public void check_ERROR_CODE_1_two_persons_null() throws Exception {
        executeAndCompare(TEST_FILE_BASE_FOLDER + "/ERROR_CODE_1_two_personFirstName_is_null");
    }

    @Test
    @DisplayName("ERROR_CODE_2 one personLastName is NULL, must not be empty")
    public void check_ERROR_CODE_2_NULL() throws Exception {
        executeAndCompare(TEST_FILE_BASE_FOLDER + "/ERROR_CODE_2_personLastName_is_null");
    }


    @Test
    @DisplayName("ERROR_CODE_2 two personLastName is NULL, must not be empty")
    public void check_ERROR_CODE_2_two_personLastName_NULL() throws Exception {
        executeAndCompare(TEST_FILE_BASE_FOLDER + "/ERROR_CODE_2_two_personLastName_is_null");
    }

    @Test
    @DisplayName("ERROR_CODE_2 one personLastName is empty, must not be empty")
    public void check_ERROR_CODE_2_EMPTY() throws Exception {
        executeAndCompare(TEST_FILE_BASE_FOLDER + "/ERROR_CODE_2_personLastName_is_empty");
    }

    @Test
    @DisplayName("ERROR_CODE_2 two personLastName is empty, must not be empty")
    public void check_ERROR_CODE_2_two_personLastName_EMPTY() throws Exception {
        executeAndCompare(TEST_FILE_BASE_FOLDER + "/ERROR_CODE_2_two_personLastName_is_empty");
    }
