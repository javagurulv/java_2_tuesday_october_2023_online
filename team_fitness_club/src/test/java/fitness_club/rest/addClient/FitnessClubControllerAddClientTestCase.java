...
public abstract class FitnessClubControllerAddClientTestCase {
    @Autowired
    ...
    protected void executeAndCompare() throws Exception {
        executeAndCompare(
                "rest/addClient/" + getTestCaseFolderName() + "/request.json",
                "rest/addClient/" + getTestCaseFolderName() + "/response.json"
        );
    }
