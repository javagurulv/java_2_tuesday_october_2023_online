...
public abstract class FitnessClubControllerUpdateClientWithNotExistingIdInDbTestCase {
    @Autowired
    ...
    private static final String BASE_URL = "/client/1";

    protected abstract String getTestCaseFolderName();

    protected void executeAndCompare() throws Exception {
        executeAndCompare(
                "rest/updateClient/" + getTestCaseFolderName() + "/request.json",
                "rest/updateClient/" + getTestCaseFolderName() + "/response.json"
        );
    }
