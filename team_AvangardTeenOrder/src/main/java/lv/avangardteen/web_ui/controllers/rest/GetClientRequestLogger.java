...
@Component
public class GetClientRequestLogger {
    private static final Logger logger = LoggerFactory.getLogger(GetClientRequestLogger.class);

    void setLogger(GetClientRequest request) {
